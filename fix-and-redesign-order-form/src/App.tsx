        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:py-24">
          <div className="animate-float-up max-w-2xl">
            ...
            <div className="mt-6 flex flex-col gap-3">
              <div className="flex items-start gap-3 rounded-2xl border-2 border-orange-brand/60 bg-orange-brand/10 px-4 py-3 backdrop-blur-sm">
                <span className="mt-0.5 text-xl">⚠️</span>
                <p className="text-sm font-semibold leading-snug text-amber-100">
                  A minimum order value of{" "}
                  <span className="font-extrabold text-white">R1,020.00</span>{" "}
                  applies. Orders below this amount will not be considered.
                </p>
              </div>
              <div className="flex items-start gap-3 rounded-2xl border border-white/15 bg-white/5 px-4 py-3 backdrop-blur-sm">
                <span className="mt-0.5 text-xl">📋</span>
                <p className="text-sm leading-snug text-slate-300">
                  Please review your order carefully before submitting —
                  orders cannot be returned once processed. Upon delivery,
                  please check that all items ordered have been received and
                  are correct.
                </p>
              </div>
            </div>
      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        ...
        <footer className="mt-4 rounded-3xl bg-navy-900 p-8 text-center sm:p-10">
          ...
          <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-slate-400">
            ...
            R15 for 25.5-30 km · R20 for 30.5-40 km · R50 for 40.5-60 km.
          </p>
          <p className="mx-auto mt-2 max-w-md text-xs font-semibold leading-relaxed text-orange-brand">
            Minimum order value: R1,020.00. Orders below this amount will not
            be considered.
          </p>
          ...
          <a
            href="#terms"
            className="mt-5 inline-block text-xs font-semibold text-slate-400 underline underline-offset-2 transition hover:text-white"
          >
        ...
        <section
          id="terms"
          className="mt-4 scroll-mt-40 rounded-3xl border border-slate-200/80 bg-white p-8 sm:p-10"
        >
          <h2 className="font-display text-xl font-bold text-navy-900 sm:text-2xl">
            Terms &amp; Conditions
          </h2>
          <ol className="mt-5 list-decimal space-y-3 pl-5 text-sm leading-relaxed text-slate-600 marker:font-bold marker:text-navy-900">
            <li>
              <span className="font-semibold text-slate-800">Minimum order:</span>{" "}
              A minimum order value of R1,020.00 applies. Orders placed below
              this amount will not be accepted or processed.
            </li>
            <li>
              <span className="font-semibold text-slate-800">Review before submitting:</span>{" "}
              Please check your order carefully before submitting it. Once an
              order has been submitted and processed, it cannot be amended or
              cancelled.
            </li>
            <li>
              <span className="font-semibold text-slate-800">No returns:</span>{" "}
              All sales are final. We do not accept returns, exchanges, or
              refunds once an order has been processed.
            </li>
            <li>
              <span className="font-semibold text-slate-800">Delivery inspection:</span>{" "}
              Upon receipt of your order, please check that all items ordered
              have been delivered and are correct. Any discrepancies must be
              reported to us as soon as possible after delivery.
            </li>
            <li>
              <span className="font-semibold text-slate-800">Delivery fees:</span>{" "}
              Delivery is free within 25&nbsp;km of our store. Deliveries
              beyond this radius are charged as follows: R15 for 25.5–30&nbsp;km,
              R20 for 30.5–40&nbsp;km, and R50 for 40.5–60&nbsp;km. We do not
              offer in-store collection.
            </li>
            <li>
              <span className="font-semibold text-slate-800">Order confirmation:</span>{" "}
              Orders are only confirmed once acknowledged by Vertex Stream
              Retail via WhatsApp or phone. Prices, availability, and images
              are provided as a guide and may change without notice.
            </li>
            <li>
              <span className="font-semibold text-slate-800">Right to refuse:</span>{" "}
              We reserve the right to refuse or cancel any order at our
              discretion, including orders that do not meet the minimum order
              value.
            </li>
            <li>
              <span className="font-semibold text-slate-800">Contact:</span>{" "}
              For any questions regarding these terms, please contact us via
              WhatsApp or phone using the details above.
            </li>
          </ol>
        </section>
      </main>
